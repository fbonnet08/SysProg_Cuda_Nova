...
python MZMineMain.py --import_db='E:\Emerging pollutants database.txt';
python MZMineMain.py --import_db='E:\Metabolite database.txt';

python MZMineMain.py --import_external_db='E:\data\ToBeInserted\NEG_LC.json' --import_db_set=single --database_origin=LC-MS
python MZMineMain.py --import_external_db='E:\data\ToBeInserted\POS_LC.json' --import_db_set=single --database_origin=LC-MS
