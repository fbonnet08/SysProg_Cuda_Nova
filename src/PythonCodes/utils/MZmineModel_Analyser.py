...
class MZmineModel_Analyser:
    ...
    # Getting the file structure in place
        ...
        rawfile_full_path_no_ext = os.path.splitext(self.rawfile_full_path)[0]
        ...
        self.m.printMesgAddStr("rawfile_full_path_no_ext   --->: ", self.c.getMagenta(), rawfile_full_path_no_ext)
