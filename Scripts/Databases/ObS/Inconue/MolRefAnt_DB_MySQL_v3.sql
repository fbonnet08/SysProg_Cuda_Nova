...
create table if not exists
    MolRefAnt_DB.Data(
                     ...
                     PRIMARY KEY(data_id),
                     FOREIGN KEY(experiment_id, scan_id) references MolRefAnt_DB.Experiment(experiment_id, scan_id)
);
...
create table if not exists
    MolRefAnt_DB.DateTable(
                          ...
                          FOREIGN KEY(analytic_data_id, date_id_1) references MolRefAnt_DB.Analytics_data(analytic_data_id, date_id)
);

INSERT INTO MolRefAnt_DB.DateTable (date_id, date_column, time_column, timestamp_with_tz_column, analytic_data_id, date_id_1)
VALUES
...
create table if not exists
    MolRefAnt_DB.Spectral_data(
                              ...
                              FOREIGN KEY(user_id) references MolRefAnt_DB.Users(user_id),
                              FOREIGN KEY(database_id) references MolRefAnt_DB.DatabaseDetails(database_id),
...
create table if not exists
    MolRefAnt_DB.Fragment(
                         ...
                         FOREIGN KEY(spectral_id, feature_id, tool_id, pi_name_id, data_collector_id) references MolRefAnt_DB.Spectral_data(spectral_id, feature_id, tool_id, pi_name_id, data_collector_id)
);
...
create table if not exists
    MolRefAnt_DB.Compound(
                         ...
                         FOREIGN KEY(spectral_id_1, feature_id, tool_id, pi_name_id, data_collector_id) references MolRefAnt_DB.Spectral_data(spectral_id, feature_id, tool_id, pi_name_id, data_collector_id)
);
...
create table if not exists
    MolRefAnt_DB.Identifying(
                            ...
                            FOREIGN KEY(experiment_id, scan_id) references MolRefAnt_DB.Experiment(experiment_id, scan_id),
                            FOREIGN KEY(coumpound_id, spectral_id) references MolRefAnt_DB.Compound(coumpound_id, spectral_id)
);
...
create table if not exists
    MolRefAnt_DB.Experimenting(
                              ...
                              FOREIGN KEY(experiment_id, scan_id) references MolRefAnt_DB.Experiment(experiment_id, scan_id),
                              FOREIGN KEY(analytic_data_id, date_id) references MolRefAnt_DB.Analytics_data(analytic_data_id, date_id)
);
...
create table if not exists
    MolRefAnt_DB.Building(
                         ...
                         FOREIGN KEY(bloc_id) references MolRefAnt_DB.BuildingBlocks(bloc_id),
                         FOREIGN KEY(spectral_id, feature_id, tool_id, pi_name_id, data_collector_id) references MolRefAnt_DB.Spectral_data(spectral_id, feature_id, tool_id, pi_name_id, data_collector_id)
);
...
create table if not exists
    MolRefAnt_DB.Ionising(
                         ...
                         FOREIGN KEY(tool_id) references MolRefAnt_DB.Tool(tool_id),
                         FOREIGN KEY(inonisation_mode_id) references MolRefAnt_DB.Ionisation_mode(inonisation_mode_id)
);
