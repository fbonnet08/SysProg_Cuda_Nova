...
drop table if exists MolRefAnt_DB.Measure cascade ;
...
create table if not exists
    ...
    FOREIGN KEY(analytics_data_id) REFERENCES MolRefAnt_DB.Analytics_data(analytics_data_id)
);
...
drop table if exists MolRefAnt_DB.User_Role cascade ;
create table if not exists
    MolRefAnt_DB.User_Role(
    user_role_id INT,
...
create table if not exists
    ...
    FOREIGN KEY(ionmodechem_id) REFERENCES MolRefAnt_DB.ionmodechem(ionmodechem_id),
    FOREIGN KEY(charge_id) REFERENCES MolRefAnt_DB.Charge(charge_id),
...
create table if not exists
    ...
    FOREIGN KEY(experiment_id) REFERENCES MolRefAnt_DB.Experiment(experiment_id),
    FOREIGN KEY(compound_id) REFERENCES MolRefAnt_DB.Compound(compound_id)
);
...
drop table if exists MolRefAnt_DB.Interpreting cascade ;
create table if not exists
    MolRefAnt_DB.Interpreting(
    spectral_data_id INT,
    user_role_id INT,
    platform_user_id int,
    PRIMARY KEY(spectral_data_id, user_role_id, platform_user_id),
    FOREIGN KEY(spectral_data_id) REFERENCES MolRefAnt_DB.Spectral_data(spectral_data_id),
    FOREIGN KEY(user_role_id) REFERENCES MolRefAnt_DB.User_Role(user_role_id),
    foreign key (platform_user_id) references MolRefAnt_DB.platform_user(platform_user_id)
);

/* insertion in the main constant table list */

insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (1, 'Positive');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (2, '[M]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (3, '[M]*+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (4, '[M+H]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (5, '[M+NH4]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (6, '[M+Na]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (7, '[M+K]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (8, '[M+CH3OH+H]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (9, '[M+ACN+H]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (10, '[M+ACN+Na]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (11, '[M+2ACN+H]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (12, '[M-H2O+H]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (13, '[frag]+');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (14, 'Negative');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (15, '[M]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (16, '[M-H]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (17, '[M+Cl]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (18, '[M+HCOO]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (19, '[M+CH3COO]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (20, '[M-2H]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (21, '[M-2H+Na]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (22, '[M-2H+K]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (23, '[M+HCOOH-H]-');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (24, 'Neutral');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (25, 'Unknown');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (26, 'N/A');
insert into MolRefAnt_DB.IonModeChem(ionmodechem_id, chemical_composition) values (27, '');

insert into MolRefAnt_DB.Charge(charge_id, charge) VALUES (1, '3-');
insert into MolRefAnt_DB.Charge(charge_id, charge) VALUES (2, '2-');
insert into MolRefAnt_DB.Charge(charge_id, charge) VALUES (3, '1-');
insert into MolRefAnt_DB.Charge(charge_id, charge) VALUES (4, '0-');
insert into MolRefAnt_DB.Charge(charge_id, charge) VALUES (5, '0');
...
insert into MolRefAnt_DB.User_Role(user_role_id, user_role) VALUES (1, 'PI');
insert into MolRefAnt_DB.User_Role(user_role_id, user_role) VALUES (2, 'DATACOLLECTOR');

insert into MolRefAnt_DB.ionisation_mode(ionisation_mode_id, ionisation_mode, signum) VALUES (1, 'Negative', -1);
insert into MolRefAnt_DB.ionisation_mode(ionisation_mode_id, ionisation_mode, signum) VALUES (2, 'Neutral', 0);
insert into MolRefAnt_DB.ionisation_mode(ionisation_mode_id, ionisation_mode, signum) VALUES (3, 'Positive', 1);
insert into MolRefAnt_DB.ionisation_mode(ionisation_mode_id, ionisation_mode, signum) VALUES (4, 'Unknown', 9);
insert into MolRefAnt_DB.ionisation_mode(ionisation_mode_id, ionisation_mode, signum) VALUES (5, 'N/A', 10);

alter table MolRefAnt_DB.tool modify instrument_source varchar(250) null;
