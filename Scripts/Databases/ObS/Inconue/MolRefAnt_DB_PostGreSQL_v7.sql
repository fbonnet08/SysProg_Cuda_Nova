...
insert into "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".tool(tool_id, instrument_source) VALUES (1, 'Banyuls_QExactive_Focus');
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".DateTable(
                                                          ...
                                                          FOREIGN KEY(analytics_data_id, date_id_1) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Analytics_data(analytics_data_id, date_id)
);
...
/*
alter table "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".logintable rename column lastename to lastname;
*/
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Experiment(
                                                           ...
                                                           foreign key (ionisation_mode_id_1) references "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Ionisation_mode(ionisation_mode_id)
);
...
create table if not exists
    ...
    FOREIGN KEY(ionmodechem_id_1) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".ionmodechem(ionmodechem_id),
    FOREIGN KEY(charge_id_1) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Charge(charge_id),
    FOREIGN KEY(tool_id_1) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Tool(tool_id),
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Compound(
                                                         ...
                                                         FOREIGN KEY(spectral_data_id_1) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Spectral_data(spectral_data_id)
);
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Experimenting(
                              ...
                              FOREIGN KEY(experiment_id) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Experiment(experiment_id),
                              FOREIGN KEY(analytics_data_id, date_id) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Analytics_data(analytics_data_id, date_id)
);
