...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Fragment(
                         ...
                         FOREIGN KEY(spectral_id) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Spectral_data(spectral_id)
);
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Compound(
                         ...
                         UNIQUE(spectral_id_1),
                         FOREIGN KEY(spectral_id_1) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Spectral_data(spectral_id)
);
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Composing(
                          experiment_id INT,
                          spectral_id INT,
                          PRIMARY KEY(experiment_id, spectral_id),
                          FOREIGN KEY(experiment_id) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Experiment(experiment_id),
                          FOREIGN KEY(spectral_id) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Spectral_data(spectral_id)
);
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Building(
                         bloc_id INT,
                         spectral_id INT,
                         PRIMARY KEY(bloc_id, spectral_id),
