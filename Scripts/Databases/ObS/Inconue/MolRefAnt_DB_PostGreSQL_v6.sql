...
drop table if exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".BuildingBlock cascade;
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".BuildingBlock(
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Data(
                                                     ...
                                                     FOREIGN KEY(experiment_id) REFERENCES
                                                         "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Experiment(experiment_id)
);

drop table if exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Platform_User cascade;
create table if not exists
...
drop table if exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Ionisation_mode cascade;
create table if not exists
...
drop table if exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Analytics_data cascade;
create table if not exists
...
drop table if exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Database_Details cascade;
create table if not exists
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".DateTable(
                                                          ...
                                                          FOREIGN
                                                              ...
                                                              "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Analytics_data(analytics_data_id,
                                                                                                                      date_id)
);
...
drop table if exists "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".LoginTable
    cascade;
create table if not exists
...
drop table if exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Spectral_data cascade;
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Spectral_data(
                                                              ...
                                                              FOREIGN KEY(tool_id) REFERENCES
                                                                  "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Tool(tool_id),
                                                              FOREIGN KEY(database_id) REFERENCES
                                                                  "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Database_Details(database_id),
                                                              FOREIGN KEY(data_id) REFERENCES
                                                                  "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Data(data_id),
                                                                  FOREIGN KEY(pi_name_id) REFERENCES
                                                                  "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Platform_User(platform_user_id),
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Fragment(
                                                         ...
                                                         FOREIGN KEY(spectral_data_id) REFERENCES
                                                             "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Spectral_data(spectral_data_id)
);
...
drop table if exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Identifying cascade;
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Identifying(
                                                            ...
                                                            FOREIGN KEY(coumpound_id) REFERENCES
                                                                "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Compound(coumpound_id)
);

drop table if exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Experimenting cascade;
create table if not exists
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Building(
                                                         ...
                                                         FOREIGN KEY(buildingblock_id) REFERENCES
                                                             "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".BuildingBlock(buildingblock_id),
                                                         FOREIGN KEY(spectral_data_id) REFERENCES
                                                             "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Spectral_data(spectral_data_id)
);
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Ionising(
                                                         ...
                                                         FOREIGN KEY(inonisation_mode_id) REFERENCES
                                                             "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Ionisation_mode(inonisation_mode_id)
);
...
create table if not exists
    "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Analysing(
                                                          ...
                                                          FOREIGN KEY(analytic_data_id) REFERENCES "MolRefAnt_DB_PostGreSQL"."MolRefAnt_DB".Analytics_data(analytics_data_id)
);
